...
const message2 = 'Bed Waether...All Fligit Delayed...'
console.log(message2.repeat(5));

// we make a function for the task

const Flight=function(n){
  console.log(`There are ${n} Fligit are ready to take off ${'✈'.repeat(n)}`);
}
